...
use std::{mem::*, ffi::c_uint};

use windows::{
    core::*, Win32::Foundation::*, Win32::Storage::FileSystem::*, Win32::System::IO::*,
};
...
impl NetworkAdapterInfo {
    pub fn new(name: String, handle: HANDLE, medium: u32, hw_address: [u8;6], mtu: u16) -> Self {
        Self { name, handle, medium, hw_address, mtu } 
    }
}
...
impl Ndisapi {
    ...
    where P: ::std::convert::Into<::windows::core::PCWSTR>{
    ...
    pub fn read_packet(&self, adapter_handle: HANDLE, packet: &mut Box<driver::IntermediateBuffer> ) -> bool {
        ...
        unsafe {
            let io_result = DeviceIoControl(
                ...
                Some(std::mem::transmute::<&driver::EthRequest, *const ::core::ffi::c_void>(&eth_request)),
                size_of::<driver::EthRequest>() as u32,
                Some(std::mem::transmute::<&driver::EthRequest, *mut ::core::ffi::c_void>(&eth_request)),
                size_of::<driver::EthRequest>() as u32,
                None,
                None
                );
    ...
    pub fn read_packets<'a, T: Iterator<Item = &'a mut Box<driver::IntermediateBuffer>>, const N: usize>(
        &self, adapter_handle: HANDLE, mut packets: T) -> usize {
    ...
    unsafe{
        ...
        let io_result = DeviceIoControl(
            ...
            Some(std::mem::transmute::<&driver::EthMRequest<N>, *const ::core::ffi::c_void>(&eth_request)),
            size_of::<driver::EthMRequest<N>>() as u32,
            Some(std::mem::transmute::<&driver::EthMRequest<N>, *mut ::core::ffi::c_void>(&eth_request)),
            size_of::<driver::EthMRequest<N>>() as u32,
            None,
            None
            );
    ...
    pub fn send_packet_to_adapter(&self, adapter_handle: HANDLE, packet: &mut Box<driver::IntermediateBuffer> ) -> bool {
        let packet = driver::EthPacket{
            buffer: packet.as_mut(),
        };
    ...
    pub fn send_packet_to_mstcp(&self, adapter_handle: HANDLE, packet: &mut Box<driver::IntermediateBuffer> ) -> bool {
        let packet = driver::EthPacket{
            buffer: packet.as_mut(),
        };
    ...
    pub fn send_packets_to_mstcp<'a, T: Iterator<Item = &'a mut Box<driver::IntermediateBuffer>>, const N: usize>(
        &self, adapter_handle: HANDLE, mut packets: T) -> bool {
        let mut eth_request: driver::EthMRequest<N>;
    ...
    pub fn send_packets_to_adapter<'a, T: Iterator<Item = &'a mut Box<driver::IntermediateBuffer>>, const N: usize>(
        &self, adapter_handle: HANDLE, mut packets: T) -> bool {
        let mut eth_request: driver::EthMRequest<N>;
    ...
    pub fn set_adapter_mode(&self, adapter_handle: HANDLE, flags: u32 ) -> Result<()> {
        ...
        unsafe {
            let io_result = DeviceIoControl(
                ...
                Some(std::mem::transmute::<&driver::AdapterMode, *const ::core::ffi::c_void>(&adapter_mode)),
    ...
    pub fn set_packet_event(&self, adapter_handle: HANDLE, event_handle: HANDLE ) -> Result<()> {
        ...
        unsafe {
            let io_result = DeviceIoControl(
                ...
                Some(std::mem::transmute::<&driver::AdapterEvent, *const ::core::ffi::c_void>(&adapter_event)),
